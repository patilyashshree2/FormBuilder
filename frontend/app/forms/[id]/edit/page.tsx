                            ...
                            <label className="flex items-center gap-2">
                              <input
                                ...
                                onChange={e => updateField(f.id, { 
                                  ...
                                  required: e.target.checked ? true : f.required // PII fields must be required
                                })}
                        ...
                        <div className="mb-4">
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              ...
                              {form.fields.filter((field: Field) => field.id !== f.id && (field.type === "single_choice" || field.type === "rating")).map((field: Field) => (
